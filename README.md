...
- Multi-layer canvas particle engines (constellation & orbital drift)
- Gravitational blackhole core acceleration
- Interactive 3D orbital projection rings
- Reactive node light emission and camera focus

## Accessibility & Mobile Support
- Full support for `prefers-reduced-motion` (clean structured cosmic node layout)
- Touch-optimized node selector for mobile devices
